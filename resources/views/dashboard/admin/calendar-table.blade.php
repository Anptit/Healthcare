                        ...
                        <div class="notification-list mx-h-350 customscroll">
                            <ul>
                                @foreach ($appointments as $appointment)
                                        <li>
                                            <a href="{{ route('admin.check-appointment', ['appointment' => $appointment]) }}">
                                                <img src="{{ asset('/frontend/vendors/images/img.jpg') }}"
                                                    alt="" />
                                                <p>
                                                    {{ $appointment->name}}
                                                </p>
    ...
    <div class="main-container">
        <div class="card-box pb-10">
            <div class="container text-center pd-20 mb-0 ">
                <span class="h2">Booking Appointment</span>
                <form class="row" action="{{ route('admin.filter-appointment') }}" method="GET">
                    @csrf
                ...
                <thead>
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                            colspan="1" aria-label="Gender: activate to sort column ascending">Email</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                            colspan="1" aria-label="Address: activate to sort column ascending">Address</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                            colspan="1" aria-label="Time: activate to sort column ascending" style="">
                            Booked Time</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                            colspan="1" aria-label="Disease: activate to sort column ascending" style="">
                            Disease</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                            colspan="1" aria-label="Phone: activate to sort column ascending" style="">
                            Phone</th>
                        ...
                        <tr role="row" class="odd">
                                ...
                                <div class="name-avatar d-flex align-items-center">
                                    ...
                                    <div class="txt">
                                        <div class="weight-600">
                                            {{ $appointment->first_name . ' ' . $appointment->last_name }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <span class="badge badge-pill" data-bgcolor="#e7ebf5" data-color="#265ed7"
                                    style="color: rgb(38, 94, 215); background-color: rgb(231, 235, 245);">{{ $appointment->disease }}</span>
                            </td>
                            <td>{{ $appointment->phone }}</td>
                            <td>
                                <div class="table-actions">
                                    <a href="{{ route('admin.edit-calendar-view', ['appointment' => $appointment]) }}"
                                        data-color="#265ed7" style="color: rgb(38, 94, 215);"><i
                                            class="icon-copy dw dw-edit2"></i>
                                    </a>
                                    <form action="{{ route('admin.del-calendar', ['appointment' => $appointment]) }}"
                                        method="POST">
                                        @csrf
                                        @method('delete')
                                        <button

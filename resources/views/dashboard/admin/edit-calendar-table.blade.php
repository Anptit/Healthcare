                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xl-6">
                                <div class="card-body p-md-5 text-black">
                                    <h3 class="mb-5 text-uppercase text-center">Updating appointment</h3>

                                    <form action="{{ route('admin.edit-calendar', $appointment) }}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="d-flex flex-column">
                                            <div class="col-md-6 w-100">
                                                <input type="text" class="form-control" placeholder="First Name"
                                                    name="fname" value="{{ $appointment->first_name }}">
                                                    
                                            </div>
                                            <div class="col-md-6 w-100 mt-3">
                                                <input type="text" class="form-control" placeholder="Last Name"
                                                    name="lname"  value="{{ $appointment->last_name }}">
                                            </div>
                                            <div class="col-md-6 w-100 mt-3">
                                            ...
                                            <div class="col-12 mt-5">
                                                ...
                                                <a class="text-decoration-none text-dark btn btn-outline-secondary float-end me-2"
                                                    href="{{ route('admin.calendar-table') }}">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>

                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xl-6">
                                <div class="card-body p-md-5 text-black">
                                    <h3 class="mb-5 text-uppercase text-center">Make an appointment</h3>

                                    <form action="{{ route('user.appointment_handler') }}" method="post">
                                        @csrf
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="col-12 mt-3">
                                                <input type="text" class="form-control" placeholder="Purpose of appointment" name="disease">
                                            </div>
